...
bitcoin_value = bitcoin_data["USD"]["last"].to_f
bitcoin_worth = bitcoin_data["USD"]["sell"].to_f*bitcoin

p "Bitcoin is valued at $#{bitcoin_value} USD"
p "#{bitcoin} Bitcoin is worth $#{bitcoin_worth} USD"
